...
> **2026-08-25 数值修复后更新**：上表为 2026-08-18 的测量。此后修复了
> Vulkan fp16 累加、CUDA flash-attn K/V→F16 与 cuBLAS TF32（见
> README「Numerical alignment」与 [VERIFICATION.md](VERIFICATION.md)），
> 后端间网格计数已重新测量：512 q8 下 CPU 1,806,350 / CUDA 1,758,271 /
> Vulkan 1,780,085，coarse q8 下后端差异 ±0.8% 以内。性能数据不受影响。
